...
function BazooKarnl.CreateWindow(libName, logoId)
    local BazooLib = Instance.new("ScreenGui")
    ...
    game:GetService("UserInputService").InputBegan:connect(function(current, ok) 
        if not ok then 
            if current.KeyCode.Name == oldKey then 
                if BazooLib.Enabled == true then
                    BazooLib.Enabled = false
                else
                    BazooLib.Enabled = true
                end
            end
        end
    end)
    ...
    --
    libName = libName or "Bazoo"
    logoId = logoId or ""
    --

    BazooLib.Name = "Bazoo Karnl"..libName
    BazooLib.Parent = game.CoreGui
    BazooLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    wave.Image = "https://tr.rbxcdn.com/8f3c4379c3d835401c167d7ab5786a67/150/150/Image/Png"
